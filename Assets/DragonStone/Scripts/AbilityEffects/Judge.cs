   ...
   public override void RegisterEventEffect()
    ...
    public void Retaliate(CreatureLogic target)
    {
        ...
        if(Random.Range(0,100)<=creature.chance)
        {
            ...
            new DealDamageCommand(target.ID, brandDamage, healthAfter: target.TakeOtherDamageVisual(creature.DealOtherDamage(brandDamage)), armorAfter:target.TakeArmorDamageVisual(creature.DealOtherDamage(brandDamage))).AddToQueue();               
